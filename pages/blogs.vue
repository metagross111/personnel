...
const title = 'Blogs';
const description = 'Content coming soon! I am currently working on updating this section, so stay tuned for fresh articles and updates.';
...
const subscribeToNewsletter = async () => {
	loading.value = true;
	await useFetch('https://usebasin.com/f/b4099e167c07', {
		method: 'post',
