<template>
	...
	>
		<nav class="mx-auto px-2 sm:px-4 max-w-5xl">
			<ul
				class="flex items-center my-4 px-3 text-sm font-medium text-gray-800 rounded-full shadow-lg bg-white/70 shadow-gray-800/5 ring-1 backdrop-blur dark:bg-gray-800/60 dark:text-gray-200 dark:ring-white/20 ring-gray-900/5"
			>
				<li
					v-for="item in items"
					:key="item.path"
